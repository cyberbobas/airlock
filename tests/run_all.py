...
SUITES = ["test_e2e.py", "test_contract.py", "test_ask.py", "test_redteam.py",
          ...
          "test_properties.py", "test_stream.py", "test_algebra.py", "test_ask_channel.py", "test_boundary.py", "test_lifecycle.py", "test_onboarding.py", "test_breach.py", "test_ai.py", "test_summary_failsafe.py", "test_allowlist.py", "test_analyst.py"]
